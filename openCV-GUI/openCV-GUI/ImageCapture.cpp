...
//    current_image_matrix = imread( "/home/mike/Development/lenna.jpg", 1 );
//    current_image_matrix = imread( "/home/mike/Development/maze2_16x13.bmp", 1 );
  //    current_image_matrix = imread( "/home/mike/Development/5x10.bmp", 1 );

//        // non-pointer version
//        IplImage image = current_image_matrix;
//        if( &image ){
//                if( _processImage ){
...
//        }
        ...
        // pointer version
        IplImage * image = current_IplImage;
//        Mat mat_img = imread( "/home/mike/Development/lenna.jpg", 1 );
       // IplImage * image = mat_img;
        if( image ){
                if( _processImage ){
...
//            current_image_matrix = imread( bytes.data(), 1 );

//            IplImage* img = cvLoadImage("greatwave.png", 1);
            this->current_IplImage = cvLoadImage(path.toAscii().data(), 1);

//            if( !current_image_matrix.data )
//              {
